    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
      <div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
        ...
        <div class="-mr-2 -my-2 md:hidden">
          <button
              @click="is_open_mobile = !is_open_mobile"
              type="button"
        ...
        <nav class="hidden md:flex space-x-10">
          <div class="relative">
            ...
            <button
                @click="is_open_solutions = !is_open_solutions"
                :class="is_open_solutions ? 'text-gray-900' : 'text-gray-500'"
                type="button"
          ...
          <div class="relative">
            <!-- Item active: "text-gray-900", Item inactive: "text-gray-500" -->
            <button
                @click="is_open_more = !is_open_more"
                :class="is_open_more ? 'text-gray-900' : 'text-gray-500'"
                type="button"
              ...
              -->
              <svg
                  :class="is_open_more ? 'text-gray-600' : 'text-gray-400'"
            ...
            <transition
                ...
                leave-to-class="opacity-0 translate-y-1"
            >
              <div v-show="is_open_more"
                   class="absolute left-1/2 transform -translate-x-1/2 mt-3 px-2 w-screen max-w-md sm:px-0">
                <div class="rounded-lg shadow-lg">
                  <div class="rounded-lg shadow-xs overflow-hidden">
                    <div class="z-20 relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                      <router-link :to="{ name: 'feedback' }" class="-m-3 p-3 flex items-start space-x-4 rounded-lg hover:bg-gray-50 transition ease-in-out duration-150">
        ...
        <div v-if="!checkAuth" class="hidden md:flex items-center justify-end space-x-8 md:flex-1 lg:w-0">
        ...
        <div v-if="checkAuth" class="hidden md:flex absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
          ...
          <div class="ml-3 relative">
            <div>
              <button @click="is_open_profile_dropdown = !is_open_profile_dropdown"
            ...
            >
              <div v-show="is_open_profile_dropdown"
                   class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg">
                <div class="py-1 rounded-md bg-white shadow-xs" role="menu" aria-orientation="vertical"
                     aria-labelledby="user-menu">
                  <router-link :to="{ path: '/redirect/backend' }"
          ...
          <div class="rounded-lg shadow-xs bg-white divide-y-2 divide-gray-50">
            <div class="pt-5 pb-6 px-5 space-y-6">
              <div class="flex items-center justify-between">
                ...
                <div class="-mr-2">
                  <button @click="is_open_mobile = !is_open_mobile"
                          type="button"
                          class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out">
                    <!-- Heroicon name: x -->
                    <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export default {
  ...
  data() {
    return {
      is_open_solutions: false,
      is_open_more: false,
      is_open_mobile: false,
      is_open_profile_dropdown: false,
    };
  },
  methods: {
    async logout() {
